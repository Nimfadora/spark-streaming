...
object BookingRecordFactory {
  ...
  private val intervalStart: Date = dateFmt.parse("2015-01-01 00:00:00")
  private val intervalEnd: Date = dateFmt.parse("2015-01-31 00:00:00")
  private val requestMaxDate: Date = dateFmt.parse("2015-01-20 00:00:00")
